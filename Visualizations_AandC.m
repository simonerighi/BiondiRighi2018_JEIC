...
% study of multiplicative wealth accumulation process (baseline) under different setup concerning the distribution of returns. Data for
% these visualizations can be created through the file Experiment_AandC.m
...
hold on
errorbar(times,mean(gini_avg(times,:),2),std(gini_avg(times,:),0,2),'Color',[255./255 196./255 0./255]);
...
legend('Normal \mu=0.05, \sigma=0.05','Normal \mu=0.025, \sigma=0.05','Normal \mu=0.075, \sigma=0.05',...
    'Normal \mu=0.05, \sigma=0.025','Normal \mu=0.05, \sigma=0.075','Gamma a=0.25, b=0.2','Location','best');
xlim([0 tmax])
saveas(1,'Exp_AC_Gini','fig')
print -depsc Exp_AC_Gini.eps
...
load('06a02b025Gamma.mat');
hold on
errorbar(times,mean(theil_avg(times,:),2),std(theil_avg(times,:),0,2),'Color',[255./255 196./255 0./255]);
...
legend('Normal \mu=0.05, \sigma=0.05','Normal \mu=0.025, \sigma=0.05','Normal \mu=0.075, \sigma=0.05',...
    'Normal \mu=0.05, \sigma=0.025','Normal \mu=0.05, \sigma=0.075','Gamma a=0.25, b=0.2','Location','best');
xlim([0 tmax])
saveas(2,'Exp_AC_Theil','fig')
print -depsc Exp_AC_Theil.eps
...
load('06a02b025Gamma.mat');
hold on
errorbar(timesma,mean(mav_Weighted_movement_W(timesma,:),2),std(mav_Weighted_movement_W(timesma,:),0,2),'Color',[255./255 196./255 0./255]);
...
legend('Normal \mu=0.05, \sigma=0.05','Normal \mu=0.025, \sigma=0.05','Normal \mu=0.075, \sigma=0.05',...
    'Normal \mu=0.05, \sigma=0.025','Normal \mu=0.05, \sigma=0.075','Gamma a=0.25, b=0.2','Location','best');
xlim([0 tmax])
saveas(3,'Exp_AC_MavWeightedMovementW','fig')
print -depsc Exp_AC_MavWeightedMovementW.eps
...
hold on
for i=10:tmax; Varricchezzeabs_MA(i-9,:)=sum(Varricchezzeabs(i-9:i,:),1)./10; end;
errorbar(timesma,mean(Varricchezzeabs_MA(timesma,:),2),std(Varricchezzeabs_MA(timesma,:),0,2),'Color',[255./255 196./255 0./255]);
...
legend('Normal \mu=0.05, \sigma=0.05','Normal \mu=0.025, \sigma=0.05','Normal \mu=0.075, \sigma=0.05',...
    'Normal \mu=0.05, \sigma=0.025','Normal \mu=0.05, \sigma=0.075','Gamma a=0.25, b=0.2','Location','best');
xlim([0 tmax])
saveas(4,'Exp_AC_Varricchezzeabs','fig')
print -depsc Exp_AC_Varricchezzeabs.eps
...
load('06a02b025Gamma.mat');
hold on
errorbar(timesma,mean(Varricchezze(timesma,:),2),std(Varricchezze(timesma,:),0,2),'Color',[255./255 196./255 0./255]);
...
xlim([0 tmax])
ylim([0 0.3])
saveas(5,'Exp_AC_Varricchezze','fig')
print -depsc Exp_AC_Varricchezze.eps
...
% % % histfit(Final_wealth);
% % % ylabel('Frequency');
% % % saveas(7,'Exp_AC_FinalWealthDistro','fig')
% % % print -depsc Exp_AC_FinalWealthDistro.eps
% % 
% % 
% % % load('baseline_setup.mat')
% % % figure(8)
...
% % % saveas(8,'Exp_AC_FinalWealthDistro_alltogether','fig')
% % % print -depsc Exp_AC_FinalWealthDistro_alltogether.eps
...
saveas(10,'Exp_AC_WealthQuartiles','fig')
print -depsc Exp_AC_WealthQuartiles.eps
...
xlim([0 11])
legend('t=1','t=10','t=100','t=1000','t=tmax','Location','best');
saveas(11,'Exp_AC_WealthDeciles','fig')
print -depsc Exp_AC_WealthDeciles.eps
...
load('06a02b025Gamma.mat');
hold on
errorbar(times,mean(Proportion_total_wealth(times,:),2),std(Proportion_total_wealth(times,:),0,2),'Color',[255./255 196./255 0./255]);
hold on
...
xlim([0 tmax])
ylim([0 1])
saveas(18,'Exp_AC_proportion_wealth_top1perc','fig')
print -depsc Exp_AC_proportion_wealth_top1perc.eps
...
lb=max(mean(Proportion_relative_wealth(timeslog,:),2),0.0001)-stdval;
hb=mean(Proportion_relative_wealth(timeslog,:),2)+stdval;
errorbar(timeslog,mean(Proportion_relative_wealth(timeslog,:),2),lb,hb,'Color',[255./255 196./255 0./255]);
set(gca,'yscale','log')
...
saveas(19,'Exp_AC_rel_proportion_top1bottom50','fig')
print -depsc Exp_AC_rel_proportion_top1bottom50.eps