...
% Visualizations for these data can be created through the file Visualizations_EandF.m
...
filename='03InterestSimpleGamma';
filename=[filename '.mat'];
...
name_experiment='Experiment_EandF/';
mkdir(name_experiment);
%Visualizzazione_EandF
